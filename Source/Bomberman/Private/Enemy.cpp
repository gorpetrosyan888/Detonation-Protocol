...
AEnemy::AEnemy()
{
	...
	SaveComp = CreateDefaultSubobject<UUnneededComponent>("CompSave");
}
...
{
	GetWorld()->GetAuthGameMode<ABombermanGameMode>()->OnEnemyDestroyed.Broadcast();
	GetMesh()->SetSimulatePhysics(true);
	GetCharacterMovement()->DisableMovement();
	ReusableDelay::StartDelay(GetWorld(), 2, this, "DieEnemy");
